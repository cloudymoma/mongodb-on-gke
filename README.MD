...
./setup.sh
```
Specify a GKE cluster name, cluster domain name for MongoDB, and machine type for GKE node. <B>(Notes that you need to specify machine type with >= 4vCPU at least)</B>
